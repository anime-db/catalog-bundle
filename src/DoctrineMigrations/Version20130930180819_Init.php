...
class Version20130930180819_Init extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function down(Schema $schema)
    {
        ...
        // remove images for sample items
...
06. Episode of Luffy: The Hand Island Adventure (130 мин, 15.12.2012)\',"602+",NULL,"+ 6 спэшлов","samples//one-piece.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
...
51. Laws and Promises (02.10.2004, 25 мин.)","51",NULL,"+ спэшл","samples/fullmetal-alchemist.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
        $this->addSql('INSERT INTO "item" VALUES(4,"feature","JP",1,"Унесённые призраками","2001-07-20",NULL,125,"Маленькая Тихиро вместе с мамой и папой переезжают в новый дом. Заблудившись по дороге, они оказываются в странном пустынном городе, где их ждет великолепный пир. Родители с жадностью набрасываются на еду и к ужасу девочки превращаются в свиней, став пленниками злой колдуньи Юбабы, властительницы таинственного мира древних богов и могущественных духов. Теперь, оказавшись одна среди магических существ и загадочных видений, отважная Тихиро должна придумать, как избавить своих родителей от чар коварной старухи и спастись из пугающего царства призраков...","'.$path.'Spirited Away (2001)'.$ds.'",NULL,"1",NULL,NULL,"samples/spirited-away.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
        $this->addSql('INSERT INTO "item" VALUES(5,"tv","JP",1,"Крутой учитель Онидзука","1999-06-30","2000-09-17",25,"Онидзука Эйкити («22 года, холост», - как он сам любит представляться) - настоящий ужас на двух колесах, член нагоняющей ужас на горожан банды мотоциклистов, решает переквалифицироваться в… школьного учителя. Ведь в любом учебном заведении полным-полно аппетитных старшеклассниц в коротеньких юбочках! Но чем глубже примеривший необычную роль хулиган окунается в перипетии общего образования, тем сильнее он пытается переиначить место работы на свой манер - одерживая одну за другой победы над царящими в школе косностью, лицемерием, показухой и безразличием.","'.$path.'GTO (1999) [TV]'.$ds.'","1. GTO - The Legend Begins (30.06.1999, 45 мин.)
...
43. Onizuka`s Final Battle (17.09.2000, 25 мин.)","43",NULL,"+ 2 эп.-коллажа","samples/gto.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
...
26. America (31.03.2005, 25 мин.)","26",NULL,NULL,"samples/beck.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
        $this->addSql('INSERT INTO "item" VALUES(7,"ova","JP",1,"Бродяга Кэнсин","1999-02-20","1999-09-22",30,"XIX век, Японию раздирает клановая вражда. Маленький Синта в детстве был продан работорговцам и попал вместе с другими в засаду - всех спутников мальчика на его глазах закололи, его же спас случайно проходивший мимо воин, мастерски владеющий мечом. Синта поступает к нему в ученики и становится мастером меча по имени Кэнсин. Парень выбирает жизненный путь убийцы экстра-класса. В одной из операций он встречает таинственную девушку Томоэ, которая видит Кэнсина в действии. Привыкший не оставлять свидетелей, самурай не убивает девушку, а забирает её с собой. Что-то дрогнуло у него в душе при виде Томоэ, возможно, она смягчит этого смелого, но холодного человека?","'.$path.'Samurai X - Trust Betrayal (1999) [OVA]'.$ds.'","1. The Man of the Slashing Sword (20.02.1999, 30 мин.)
2. The Lost Cat (21.04.1999, 30 мин.)
3. The Previous Night at the Mountain Home (19.06.1999, 30 мин.)
4. The Cross-Shaped Wound (22.09.1999, 30 мин.)","4",NULL,NULL,"samples/samurai-x-trust-betrayal.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
        $this->addSql('INSERT INTO "item" VALUES(8,"feature","JP",1,"Мой сосед Тоторо","1988-04-16",NULL,88,"Япония, пятидесятые годы прошлого века. Переехав в деревню, две маленькие сестры Сацуки (старшая) и Мэй (младшая) глубоко внутри дерева обнаружили необыкновенный, чудесный мир, населённый Тоторо, очаровательными пушистыми созданиями, с которыми у девочек сразу же завязалась дружба. Одни из них большие, другие совсем крохотные, но у всех у них огромное, доброе сердце и магические способности совершать необыкновенные вещи, наподобие полётов над горами или взращивания огромного дерева за одну ночь! Но увидеть этих существ могут лишь дети, которые им приглянутся... Подружившись с сёстрами, Тоторо не только устраивают им воздушную экскурсию по своим владениям, но и помогают Мэй повидаться с лежащей в больнице мамой.","'.$path.'Tonari no Totoro (1988) [TV]'.$ds.'",NULL,"1",NULL,NULL,"samples/tonari-no-totoro.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
...
Вторая экранизация манги Хирано Кота дотошно следует оригиналу, и потому заметно отличается от сериала, ведь именно чёрный юмор, реки крови, харизматичные враги и закрученный конфликт сделали «Хеллсинга» всемирно популярным.","'.$path.'Hellsing (2006) [OVA]'.$ds.'","1. Hellsing I (10.02.2006, 50 мин.)
...
10. Hellsing X (26.12.2012, 65 мин.)","10",NULL,"+ 4 спэшла","samples/hellsing.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
...
201. Everybody`s a Santa!\',"201",NULL,NULL,"samples/gintama.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
...
27. All the Lights in the Sky are Stars (30.09.2007, 25 мин.)","27",NULL,"+ 2 спэшла","samples/tengen-toppa-gurren-lagann.jpg","'.date('Y-m-d H:i:s').'","'.date('Y-m-d H:i:s').'")');
        // add sequence
