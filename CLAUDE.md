...
Краткие справки для агента — читать на лету по индексу [`.claude-docs/index.md`](.claude-docs/index.md):

| Файл                                                 | Когда читать                                                         |
|------------------------------------------------------|----------------------------------------------------------------------|
| [.claude-docs/index.md](.claude-docs/index.md)       | Не уверен, что читать — начни отсюда (таблица маршрутизации)         |
| [.claude-docs/gotchas.md](.claude-docs/gotchas.md)   | «Почему так / выглядит странно или ломается» — нетривиальные ловушки |
| [.claude-docs/glossary.md](.claude-docs/glossary.md) | Непонятный термин, аббревиатура, странное имя класса/метода          |
